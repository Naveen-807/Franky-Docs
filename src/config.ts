...
const EnvSchema = z.object({
  ...
  BCH_ENABLED: z.string().optional().default("1").pipe(BoolString),
  BCH_NETWORK: z.string().optional().default("mainnet").transform((v) => v.trim()),
  BCH_REST_URL: z.string().optional().default("https://api.fullstack.cash/v5/").transform((v) => v.trim()),
  BCH_CASHTOKENS_ENABLED: z.string().optional().default("1").pipe(BoolString),
  BCH_NFT_ENABLED: z.string().optional().default("1").pipe(BoolString),
  BCH_MULTISIG_ENABLED: z.string().optional().default("1").pipe(BoolString),
  CASH_ENABLED: z.string().optional().default("1").pipe(BoolString),
  BCH_PAYMENTS_ENABLED: z.string().optional().default("1").pipe(BoolString),
